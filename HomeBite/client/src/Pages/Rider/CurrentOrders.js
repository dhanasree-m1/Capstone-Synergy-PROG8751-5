...
const CurrentOrders = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      setOrders(json.data.getCurrentOrdersRider);
    } catch (error) {
    ...
    try {
      ...
      await fetch("https://homebite-app-c680d0ee15d5.herokuapp.com/graphql", {
        ...
        body: JSON.stringify({
          query: `
            mutation {
              updateOrderStatusRider(orderId: "${orderId}", status: "${action}",rider_id:"${rider_id}") {
                success
                message
              }
            }
    ...
    <Row>
      ...
      <div className="col-12 mt-2">
        ...
        <div className="tab-selector">
          <Link to="/rider/orders" className="tab active">Current Orders</Link>
          <Link to="/rider/orders/in-progress" className="tab ">Orders Inprogress</Link>
